# Generated by Django 3.1.2 on 2022-10-11 05:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Consultas',
            fields=[
                ('idConsultas', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(default='Nombre', max_length=20, unique=True)),
                ('ApellidoPaterno', models.CharField(max_length=20)),
                ('ApellidoMaterno', models.CharField(max_length=20)),
                ...
                ('password', models.TextField(default='Contraseña', max_length=30)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hola9', to='social.paciente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peso', models.FloatField()),
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hola3', to='social.paciente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hola5', to='social.paciente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hola8', to='social.paciente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hola4', to='social.paciente')),
            ],
            options={
